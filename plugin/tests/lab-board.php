...
$board->place($ada, (int) $chair->id(), AssociationDate::fromIso('2024-01-01'), null, 'ordf@example.test', '2024');
$replaced = $board->place($grace, (int) $chair->id(), AssociationDate::fromIso('2024-06-01'), null, '', '');
...
foreach ($board->history(AssociationDate::fromIso('2024-07-01')) as $post) {
    ...
    if ($assignment->personId() === $ada && $post->roleSlug() === 'chair') {
